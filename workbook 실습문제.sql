-- 1번
-- 춘 기술대학교의 학과 이름을 표시하시오
-- 단, 출력 헤더는 "학과 명, "계열으로 표시하도록 한다.
...
-- 4번
-- 도서관에서 대출 도서 장기 연체자들을 찾아 이름을 게시하시오
