 ...
 * [START WITH 숫자] -- 처음 발생시킬 시작값 지정, 생략하면 자동 1인 기본
 * [ICEREMENT BY 숫자] -- 다음 값에 대한 증가치, 생략하면 자동 1이 기본
...
-- * CURRVAL 주의사항 *
--> CURRVAL는 마지막 NECTVAL 호출 값을 보여주는 기능
...
INSERT INTO EMP_TEMP VALUES(SEQ_TEMP.NEXTVAL, '홍길동'); -- 233
