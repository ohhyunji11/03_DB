/*
 * VIEW
 * - SELECT문의 실행 결과(RESULT SET)을 화면 저장하는 객체 
 * - 논리적 가상 테이블
 ...
 * 2) VIEW를 이용한 DML(INSERT/UPDATE/DELETE)DL
 *		가능한 경우도 있지만
...
-- VIEW의 본래 목적인 보여지는 것(조회)라른 용도에 맞게 사용하는게 좋다
