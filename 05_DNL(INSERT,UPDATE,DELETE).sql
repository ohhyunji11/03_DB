...
-- 선택 안 된 컬럼은 값이 NULL이 들어감 (DEFAULT 존재 시 DEFAULT 값으로 삽입됨)

INSERT INTO EMPLOYEE2(EMP_ID, EMP_NAME, EMP_NO, EMAIL, PHONE,
									DEPT_CODE, JOB_CODE, SAL_LEVEL, SALARY)
VALUES('900', '장채현', '9001123-2345678', 'jang_ch@kh.or.kr', '01012341234',
		'D1', 'J7', 'S3', 4300000);
...
DEPT_ID = 'D0',
DEPT_TITLE = '전략기획팀' -- WHERE절 직전 컬럼 작성 콤마 X
WHERE DEPT_ID = 'D9'
AND DEPT_TITLE = '총무부';
...
SELECT * FROM EMP_M02; -- 5명 (기존4 + 신규 1)
...
-- 롤백 후 복구 확인
SELECT * FROM EMPLOYEE3; -- 복구 안됨을 확인!
