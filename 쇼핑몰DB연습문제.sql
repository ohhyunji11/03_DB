...
INSERT INTO ORDERS VALUES(576, 1, TO_DATE('20240229'), 'N');
INSERT INTO ORDERS VALUES(978, 2, SYSDATE, 'Y');
INSERT INTO ORDERS VALUES(777, 2, SYSDATE, 'N');
INSERT INTO ORDERS VALUES(134, 1, TO_DATE('20221225'), 'Y');
INSERT INTO ORDERS VALUES(499, 1, TO_DATE('20200103'), 'Y');
...
VALUES(111, 576, 101, 1, 
(SELECT PRICE FROM PRODUCTS WHERE PRODUCT_ID = 101));

INSERT INTO ORDER_DETAILS 
VALUES(222, 978, 201, 2, 
(SELECT PRICE FROM PRODUCTS WHERE PRODUCT_ID = 201));

INSERT INTO ORDER_DETAILS 
VALUES(333, 978, 102, 1, 
(SELECT PRICE FROM PRODUCTS WHERE PRODUCT_ID = 102));

INSERT INTO ORDER_DETAILS 
VALUES(444, 777, 301, 5, 
(SELECT PRICE FROM PRODUCTS WHERE PRODUCT_ID = 301));

INSERT INTO ORDER_DETAILS 
VALUES(555, 134, 102, 1, 
(SELECT PRICE FROM PRODUCTS WHERE PRODUCT_ID = 102));

INSERT INTO ORDER_DETAILS 
VALUES(666, 499, 201, 3, 
(SELECT PRICE FROM PRODUCTS WHERE PRODUCT_ID = 201));
...
-- 아직 처리가 안된 주문 내역 조회(고객명, 주문일, 처리상태)
...
-- 유관순이 주문한 상품의 수량 별 금액 조회
-- 주문번호, 상품명, 수량, 개별금액, 주문별금액 조회
SELECT ORDER_ID 주문번호, 
PRODUCT_NAME 상품명,
QUANTITY 수량, PRICE_PER_UNIT 개별금액,
SUM(PRICE_PER_UNIT * QUANTITY) 주문별금액합계
FROM ORDERS
NATURAL JOIN CUSTOMERS
NATURAL JOIN ORDER_DETAILS
NATURAL JOIN PRODUCTS
WHERE NAME = '유관순'
GROUP BY NAME, PRODUCT_NAME, ORDER_ID, QUANTITY, PRICE_PER_UNIT;
